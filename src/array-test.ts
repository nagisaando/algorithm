// This test proves that javascript array is
// - getting element by index => O(1)
// - Push / Pop => O(1)
// - Unshift / Shift => O(n)
// => It is using ArrayList (data structure) behind the scene
// => const a = [] is not really "array"
// => array can not "grow" but arrayList can
const a: number[] = [];
